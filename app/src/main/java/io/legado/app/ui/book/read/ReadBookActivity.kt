    ...
    private fun applyRotationEntry(entry: String) {
        ...
        when {
            pureEntry.startsWith("pagtheme:") -> {
                ...
                ReadBookConfig.parseThemeFontColor(dir)?.let { fontColor ->
